...
const ViewCardDetail = () => {
    ...
    const retrieveCard = async () => {
        setShowSpinner(true);
        try {
            let response: any = await cardsService.retrieveCard({ id: account_id, card_id: card_id });
            ...
            if (
                ...
                //setCardData(["response"]);
                console.log('CardAPIResponse', response)
                console.log('CardState', cardData)
            }
        } catch (ex) {
            setShowSpinner(false);
        }
                        ...
                        {cardData && cardData.map((card: any) => {
                            ...
                            return (
                                <div className="ml-2 relative mt-2">
                                    <button
                                        type="button"
                                        className="bg-green-200 text-green-500 text-xs font-bold border border-green-300 rounded-full py-1 px-2 w-30"
                                    >
                                        {status}
                                    </button>
                                    <button
                                        type="button"
                                        className="bg-gray-200  text-gray-500 text-xs font-bold border border-gray-300 rounded-full py-1 px-2 w-30 ml-2"
                                    >
                                        {`${type} ${'Card'}`}
                                    </button>
                                </div>
                            ...
                            <div className="cards-section fs-box-shadow flex flex-col">
                                ...
                                <div className="cards-list">
                                    ...
                                    <div className="card-number border-b border-gray-200 py-2 px-2">
                                        <div className="no-of-cards text-gray-500 text-xs">Card Number</div>
                                    ...
                                    <div className="cvv border-b border-gray-200 py-2 px-2">
                                        <div className="no-of-cards text-gray-500 text-xs">Expiry</div>
                                        <div className="cards-type font-semibold text-sm py-1">{exp_date}</div>
                                    </div>
                                    <div className="cvv border-b border-gray-200 py-2 px-2">
                                        <div className="no-of-cards text-gray-500 text-xs">CVV</div>
                                        <div className="absolute ml-[210px] mt-[-4px]">
                                            <a href="">
                                                <svg
                                                    width="16"
                                        ...
                                        <div className="cards-type font-semibold text-sm py-1">****</div>
                                    </div>
                    ...
                    <div className="bl-section flex flex-col">
                            ...
                            <div className=" flex flex-row justify-between mb-2 mt-8">
                               {
                                ...
                                <div className="total-issued-cards mt-2 mr-[100px]">
                                    <div className="no-of-cards text-xs font-semibold">$2,000</div>
                                    <div className="cards-type text-gray-500 text-[10px]">
                                        Spent
                                    </div>
                                </div>
                                <div className="total-issued-cards mt-2 mx-2">
                                    <div className="no-of-cards text-xs font-semibold ml-4">
                                        $500
                                    </div>
                                    <div className="cards-type text-gray-500 text-[10px]">
                                        Remaining
                        ...
                        <div className="fs-box-shadow ts-section mt-4 ml-4">
                            <div className="ts-header px-3 py-3 border-b border-gray-200">
                                <span className="flex justify-between font-bold">Transactions</span>
                            </div>
